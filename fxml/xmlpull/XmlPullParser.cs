...
namespace cn.noisyfox.fxml.xmlpull
{
     ...
     */
        ...
        public const string FEATURE_PROCESS_NAMESPACES =
     ...
     */
        ...
        public const string FEATURE_REPORT_NAMESPACE_ATTRIBUTES =
     ...
     */
        ...
        public const string FEATURE_PROCESS_DOCDECL =
     ...
     */
        ...
        public const string FEATURE_VALIDATION =
     ...
     */
        ...
        public abstract void defineEntityReplacementText(string entityName,
     ...
     */
        ...
        public abstract string getAttributeValue(string namespace_,
            string name);
     ...
     * </pre>
     */
        public abstract void require(int type, string namespace_, string name);
